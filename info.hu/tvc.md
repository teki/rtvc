...
4. A kurzor interrupt azonnal összekapcsolja a CPU és CRTC időzítését.
5. A UI akkor kap új képet, amikor megjeleníthető framebuffer készült. Szinkronvesztéskor a gép fekete hátteret és mozgó fehér csíkokat jelenít meg.
...
| `0x05` | Hang / kazetta | frekvencia felső bájt, hang enable, interrupt enable, kazettamotor |
| `0x06` | Többfunkciós | videomód, hangerő, printer ACK |
...
| `0x70` | CRTC | MC6845 címindex |
| `0x71` | CRTC | MC6845 adatregiszter |
...
1. CRTC kurzoregyezés vagy hangidőzítő beállítja az aktív-alacsony interruptbitet.
