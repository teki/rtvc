...
180 GOSUB 700
190 A=0
200 PRINT AT 15,9;"Total scanlines = ";(R(4)+1)*(R(9)+1)+R(5);"    "
210 PRINT AT 16,9;"Displayed bytes = ";R(1)*R(6);"      "
220 PRINT AT 2+A,2;"=>";
...
510 CLS
520 FOR Y=0 TO 23 : PRINT AT Y,0;Y; : NEXT
530 FOR X=0 TO 63 : PRINT AT 0,X;X-INT(X/10)*10; : NEXT
540 PRINT AT 18,10;"Use cursor keys to"
550 PRINT AT 19,10;"change register values"
560 PRINT AT 20,10;"Press R to reset"
570 FOR I=0 TO M : A=I : GOSUB 650 : NEXT
580 RETURN
...
650 PRINT AT 2+A,5;N$(A);TAB(27);"R";A;"=";R(A);"  "
660 RETURN
