...
5. **Interrupt Handling**: If the CRTC is initialized and Z80 interrupts are enabled (`iff1 != 0`), fires a single cursor interrupt (IRQ) per host screen tick via `z80.irq()`.
