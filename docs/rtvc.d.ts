...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4626: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4631: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1461: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1461_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1463: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1203: (a: number, b: number) => void;
