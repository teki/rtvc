...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4269: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4274: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1173: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1173_2: (a: number, b: number, c: number) => void;
