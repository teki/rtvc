...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4709: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4714: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1544: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1544_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1546: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1271: (a: number, b: number) => void;
