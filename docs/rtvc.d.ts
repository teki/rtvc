...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4712: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4717: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1547: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1547_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1549: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1274: (a: number, b: number) => void;
