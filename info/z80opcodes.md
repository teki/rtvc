...
- `T`: T-states. Conditional timings use `taken/not-taken`, for example `12/7`.
- `F`: affected flags in `SZHPNC` order.
- Flag characters: `-` unaffected, `*` affected, `0` reset, `1` set, `P` parity, `V` overflow, `?` undefined or undocumented.

```text
NN      EQU     1234H           ; a sixteen bit number
N       EQU     56H             ; an eight bit number

        NOP                     ; 00         ; T=4     F=------ No Operation
        LD BC,NN                ; 01 XX XX   ; T=10    F=------ Load: dst=src
        LD (BC),A               ; 02         ; T=7     F=------ Load: dst=src
        INC BC                  ; 03         ; T=6     F=------ Increment: xx=xx+1
        INC B                   ; 04         ; T=4     F=***V0- Increment: s=s+1
        DEC B                   ; 05         ; T=4     F=***V1- Decrement: s=s-1
        LD B,N                  ; 06 XX      ; T=7     F=------ Load: dst=src
        RLCA                    ; 07         ; T=4     F=--0-0* Rotate Left Circular: A=A<-
        EX AF,AF'               ; 08         ; T=4     F=------ Exchange: AF<->AF'
        ADD HL,BC               ; 09         ; T=11    F=--?-0* Add: HL=HL+ss
        LD A,(BC)               ; 0A         ; T=7     F=------ Load: dst=src
        DEC BC                  ; 0B         ; T=6     F=------ Decrement: xx=xx-1
        INC C                   ; 0C         ; T=4     F=***V0- Increment: s=s+1
        DEC C                   ; 0D         ; T=4     F=***V1- Decrement: s=s-1
        LD C,N                  ; 0E XX      ; T=7     F=------ Load: dst=src
        RRCA                    ; 0F         ; T=4     F=--0-0* Rotate Right Circular: A=->A
        DJNZ $+2                ; 10         ; T=13/8  F=------ Dec., Jump Non-Zero: B=B-1 till B=0
        LD DE,NN                ; 11 XX XX   ; T=10    F=------ Load: dst=src
        LD (DE),A               ; 12         ; T=7     F=------ Load: dst=src
        INC DE                  ; 13         ; T=6     F=------ Increment: xx=xx+1
        INC D                   ; 14         ; T=4     F=***V0- Increment: s=s+1
        DEC D                   ; 15         ; T=4     F=***V1- Decrement: s=s-1
        LD D,N                  ; 16 XX      ; T=7     F=------ Load: dst=src
        RLA                     ; 17         ; T=4     F=--0-0* Rotate Left Acc.: A={CY,A}<-
        JR $+2                  ; 18         ; T=12    F=------ Unconditional Jump: PC=PC+e
        ADD HL,DE               ; 19         ; T=11    F=--?-0* Add: HL=HL+ss
        LD A,(DE)               ; 1A         ; T=7     F=------ Load: dst=src
        DEC DE                  ; 1B         ; T=6     F=------ Decrement: xx=xx-1
        INC E                   ; 1C         ; T=4     F=***V0- Increment: s=s+1
        DEC E                   ; 1D         ; T=4     F=***V1- Decrement: s=s-1
        LD E,N                  ; 1E XX      ; T=7     F=------ Load: dst=src
        RRA                     ; 1F         ; T=4     F=--0-0* Rotate Right Acc.: A=->{CY,A}
        JR NZ,$+2               ; 20         ; T=12/7  F=------ Conditional Jump: If cc JR
        LD HL,NN                ; 21 XX XX   ; T=10    F=------ Load: dst=src
        LD (NN),HL              ; 22 XX XX   ; T=16    F=------ Load: dst=src
        INC HL                  ; 23         ; T=6     F=------ Increment: xx=xx+1
        INC H                   ; 24         ; T=4     F=***V0- Increment: s=s+1
        DEC H                   ; 25         ; T=4     F=***V1- Decrement: s=s-1
        LD H,N                  ; 26 XX      ; T=7     F=------ Load: dst=src
        DAA                     ; 27         ; T=4     F=***P-* Decimal Adjust Acc.: A=BCD format
        JR Z,$+2                ; 28         ; T=12/7  F=------ Conditional Jump: If cc JR
        ADD HL,HL               ; 29         ; T=11    F=--?-0* Add: HL=HL+ss
        LD HL,(NN)              ; 2A XX XX   ; T=16    F=------ Load: dst=src
        DEC HL                  ; 2B         ; T=6     F=------ Decrement: xx=xx-1
        INC L                   ; 2C         ; T=4     F=***V0- Increment: s=s+1
        DEC L                   ; 2D         ; T=4     F=***V1- Decrement: s=s-1
        LD L,N                  ; 2E XX      ; T=7     F=------ Load: dst=src
        CPL                     ; 2F         ; T=4     F=--1-1- Complement: A=~A
        JR NC,$+2               ; 30         ; T=12/7  F=------ Conditional Jump: If cc JR
        LD SP,NN                ; 31 XX XX   ; T=10    F=------ Load: dst=src
        LD (NN),A               ; 32 XX XX   ; T=13    F=------ Load: dst=src
        INC SP                  ; 33         ; T=6     F=------ Increment: xx=xx+1
        INC (HL)                ; 34         ; T=11    F=***V0- Increment: s=s+1
        DEC (HL)                ; 35         ; T=11    F=***V1- Decrement: s=s-1
        LD (HL),N               ; 36 XX      ; T=10    F=------ Load: dst=src
        SCF                     ; 37         ; T=4     F=--0-01 Set Carry Flag: CY=1
        JR C,$+2                ; 38         ; T=12/7  F=------ Conditional Jump: If cc JR
        ADD HL,SP               ; 39         ; T=11    F=--?-0* Add: HL=HL+ss
        LD A,(NN)               ; 3A XX XX   ; T=13    F=------ Load: dst=src
        DEC SP                  ; 3B         ; T=6     F=------ Decrement: xx=xx-1
        INC A                   ; 3C         ; T=4     F=***V0- Increment: s=s+1
        DEC A                   ; 3D         ; T=4     F=***V1- Decrement: s=s-1
        LD A,N                  ; 3E XX      ; T=7     F=------ Load: dst=src
        CCF                     ; 3F         ; T=4     F=--*-0* Complement Carry Flag: CY=~CY
        LD B,B                  ; 40         ; T=4     F=------ Load: dst=src
        LD B,C                  ; 41         ; T=4     F=------ Load: dst=src
        LD B,D                  ; 42         ; T=4     F=------ Load: dst=src
        LD B,E                  ; 43         ; T=4     F=------ Load: dst=src
        LD B,H                  ; 44         ; T=4     F=------ Load: dst=src
        LD B,L                  ; 45         ; T=4     F=------ Load: dst=src
        LD B,(HL)               ; 46         ; T=7     F=------ Load: dst=src
        LD B,A                  ; 47         ; T=4     F=------ Load: dst=src
        LD C,B                  ; 48         ; T=4     F=------ Load: dst=src
        LD C,C                  ; 49         ; T=4     F=------ Load: dst=src
        LD C,D                  ; 4A         ; T=4     F=------ Load: dst=src
        LD C,E                  ; 4B         ; T=4     F=------ Load: dst=src
        LD C,H                  ; 4C         ; T=4     F=------ Load: dst=src
        LD C,L                  ; 4D         ; T=4     F=------ Load: dst=src
        LD C,(HL)               ; 4E         ; T=7     F=------ Load: dst=src
        LD C,A                  ; 4F         ; T=4     F=------ Load: dst=src
        LD D,B                  ; 50         ; T=4     F=------ Load: dst=src
        LD D,C                  ; 51         ; T=4     F=------ Load: dst=src
        LD D,D                  ; 52         ; T=4     F=------ Load: dst=src
        LD D,E                  ; 53         ; T=4     F=------ Load: dst=src
        LD D,H                  ; 54         ; T=4     F=------ Load: dst=src
        LD D,L                  ; 55         ; T=4     F=------ Load: dst=src
        LD D,(HL)               ; 56         ; T=7     F=------ Load: dst=src
        LD D,A                  ; 57         ; T=4     F=------ Load: dst=src
        LD E,B                  ; 58         ; T=4     F=------ Load: dst=src
        LD E,C                  ; 59         ; T=4     F=------ Load: dst=src
        LD E,D                  ; 5A         ; T=4     F=------ Load: dst=src
        LD E,E                  ; 5B         ; T=4     F=------ Load: dst=src
        LD E,H                  ; 5C         ; T=4     F=------ Load: dst=src
        LD E,L                  ; 5D         ; T=4     F=------ Load: dst=src
        LD E,(HL)               ; 5E         ; T=7     F=------ Load: dst=src
        LD E,A                  ; 5F         ; T=4     F=------ Load: dst=src
        LD H,B                  ; 60         ; T=4     F=------ Load: dst=src
        LD H,C                  ; 61         ; T=4     F=------ Load: dst=src
        LD H,D                  ; 62         ; T=4     F=------ Load: dst=src
        LD H,E                  ; 63         ; T=4     F=------ Load: dst=src
        LD H,H                  ; 64         ; T=4     F=------ Load: dst=src
        LD H,L                  ; 65         ; T=4     F=------ Load: dst=src
        LD H,(HL)               ; 66         ; T=7     F=------ Load: dst=src
        LD H,A                  ; 67         ; T=4     F=------ Load: dst=src
        LD L,B                  ; 68         ; T=4     F=------ Load: dst=src
        LD L,C                  ; 69         ; T=4     F=------ Load: dst=src
        LD L,D                  ; 6A         ; T=4     F=------ Load: dst=src
        LD L,E                  ; 6B         ; T=4     F=------ Load: dst=src
        LD L,H                  ; 6C         ; T=4     F=------ Load: dst=src
        LD L,L                  ; 6D         ; T=4     F=------ Load: dst=src
        LD L,(HL)               ; 6E         ; T=7     F=------ Load: dst=src
        LD L,A                  ; 6F         ; T=4     F=------ Load: dst=src
        LD (HL),B               ; 70         ; T=7     F=------ Load: dst=src
        LD (HL),C               ; 71         ; T=7     F=------ Load: dst=src
        LD (HL),D               ; 72         ; T=7     F=------ Load: dst=src
        LD (HL),E               ; 73         ; T=7     F=------ Load: dst=src
        LD (HL),H               ; 74         ; T=7     F=------ Load: dst=src
        LD (HL),L               ; 75         ; T=7     F=------ Load: dst=src
        HALT                    ; 76         ; T=4     F=------ Halt
        LD (HL),A               ; 77         ; T=7     F=------ Load: dst=src
        LD A,B                  ; 78         ; T=4     F=------ Load: dst=src
        LD A,C                  ; 79         ; T=4     F=------ Load: dst=src
        LD A,D                  ; 7A         ; T=4     F=------ Load: dst=src
        LD A,E                  ; 7B         ; T=4     F=------ Load: dst=src
        LD A,H                  ; 7C         ; T=4     F=------ Load: dst=src
        LD A,L                  ; 7D         ; T=4     F=------ Load: dst=src
        LD A,(HL)               ; 7E         ; T=7     F=------ Load: dst=src
        LD A,A                  ; 7F         ; T=4     F=------ Load: dst=src
        ADD A,B                 ; 80         ; T=4     F=***V0* Add: A=A+s
        ADD A,C                 ; 81         ; T=4     F=***V0* Add: A=A+s
        ADD A,D                 ; 82         ; T=4     F=***V0* Add: A=A+s
        ADD A,E                 ; 83         ; T=4     F=***V0* Add: A=A+s
        ADD A,H                 ; 84         ; T=4     F=***V0* Add: A=A+s
        ADD A,L                 ; 85         ; T=4     F=***V0* Add: A=A+s
        ADD A,(HL)              ; 86         ; T=7     F=***V0* Add: A=A+s
        ADD A,A                 ; 87         ; T=4     F=***V0* Add: A=A+s
        ...
        SUB B                   ; 90         ; T=4     F=***V1* Subtract: A=A-s
        SUB C                   ; 91         ; T=4     F=***V1* Subtract: A=A-s
        SUB D                   ; 92         ; T=4     F=***V1* Subtract: A=A-s
        SUB E                   ; 93         ; T=4     F=***V1* Subtract: A=A-s
        SUB H                   ; 94         ; T=4     F=***V1* Subtract: A=A-s
        SUB L                   ; 95         ; T=4     F=***V1* Subtract: A=A-s
        SUB (HL)                ; 96         ; T=7     F=***V1* Subtract: A=A-s
        SUB A                   ; 97         ; T=4     F=***V1* Subtract: A=A-s
        ...
        CP B                    ; B8         ; T=4     F=***V1* Compare: A-s
        CP C                    ; B9         ; T=4     F=***V1* Compare: A-s
        CP D                    ; BA         ; T=4     F=***V1* Compare: A-s
        CP E                    ; BB         ; T=4     F=***V1* Compare: A-s
        CP H                    ; BC         ; T=4     F=***V1* Compare: A-s
        CP L                    ; BD         ; T=4     F=***V1* Compare: A-s
        CP (HL)                 ; BE         ; T=7     F=***V1* Compare: A-s
        CP A                    ; BF         ; T=4     F=***V1* Compare: A-s
        RET NZ                  ; C0         ; T=11/5  F=------ Conditional Return: If cc RET
        POP BC                  ; C1         ; T=10    F=------ Pop: register=[SP]+
        JP NZ,$+3               ; C2         ; T=10    F=------ Conditional Jump: If cc JP
        JP $+3                  ; C3         ; T=10    F=------ Unconditional Jump: PC=nn
        CALL NZ,NN              ; C4 XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        PUSH BC                 ; C5         ; T=11    F=------ Push: -[SP]=register
        ADD A,N                 ; C6 XX      ; T=7     F=***V0* Add: A=A+s
        RST 0                   ; C7         ; T=11    F=------ Restart: (p=0H,8H,10H,...,38H)
        RET Z                   ; C8         ; T=11/5  F=------ Conditional Return: If cc RET
        RET                     ; C9         ; T=10    F=------ Return: PC=[SP]+
        JP Z,$+3                ; CA         ; T=10    F=------ Conditional Jump: If cc JP
        RLC B                   ; CB 00      ; T=8     F=**0P0* Rotate Left Circular: m=m<-
        RLC C                   ; CB 01      ; T=8     F=**0P0* Rotate Left Circular: m=m<-
        RLC D                   ; CB 02      ; T=8     F=**0P0* Rotate Left Circular: m=m<-
        RLC E                   ; CB 03      ; T=8     F=**0P0* Rotate Left Circular: m=m<-
        RLC H                   ; CB 04      ; T=8     F=**0P0* Rotate Left Circular: m=m<-
        RLC L                   ; CB 05      ; T=8     F=**0P0* Rotate Left Circular: m=m<-
        RLC (HL)                ; CB 06      ; T=15    F=**0P0* Rotate Left Circular: m=m<-
        RLC A                   ; CB 07      ; T=8     F=**0P0* Rotate Left Circular: m=m<-
        RRC B                   ; CB 08      ; T=8     F=**0P0* Rotate Right Circular: m=->m
        RRC C                   ; CB 09      ; T=8     F=**0P0* Rotate Right Circular: m=->m
        RRC D                   ; CB 0A      ; T=8     F=**0P0* Rotate Right Circular: m=->m
        RRC E                   ; CB 0B      ; T=8     F=**0P0* Rotate Right Circular: m=->m
        RRC H                   ; CB 0C      ; T=8     F=**0P0* Rotate Right Circular: m=->m
        RRC L                   ; CB 0D      ; T=8     F=**0P0* Rotate Right Circular: m=->m
        RRC (HL)                ; CB 0E      ; T=15    F=**0P0* Rotate Right Circular: m=->m
        RRC A                   ; CB 0F      ; T=8     F=**0P0* Rotate Right Circular: m=->m
        RL  B                   ; CB 10      ; T=8     F=**0P0* Rotate Left: m={CY,m}<-
        RL  C                   ; CB 11      ; T=8     F=**0P0* Rotate Left: m={CY,m}<-
        RL  D                   ; CB 12      ; T=8     F=**0P0* Rotate Left: m={CY,m}<-
        RL  E                   ; CB 13      ; T=8     F=**0P0* Rotate Left: m={CY,m}<-
        RL  H                   ; CB 14      ; T=8     F=**0P0* Rotate Left: m={CY,m}<-
        RL  L                   ; CB 15      ; T=8     F=**0P0* Rotate Left: m={CY,m}<-
        RL  (HL)                ; CB 16      ; T=15    F=**0P0* Rotate Left: m={CY,m}<-
        RL  A                   ; CB 17      ; T=8     F=**0P0* Rotate Left: m={CY,m}<-
        RR  B                   ; CB 18      ; T=8     F=**0P0* Rotate Right: m=->{CY,m}
        RR  C                   ; CB 19      ; T=8     F=**0P0* Rotate Right: m=->{CY,m}
        RR  D                   ; CB 1A      ; T=8     F=**0P0* Rotate Right: m=->{CY,m}
        RR  E                   ; CB 1B      ; T=8     F=**0P0* Rotate Right: m=->{CY,m}
        RR  H                   ; CB 1C      ; T=8     F=**0P0* Rotate Right: m=->{CY,m}
        RR  L                   ; CB 1D      ; T=8     F=**0P0* Rotate Right: m=->{CY,m}
        RR  (HL)                ; CB 1E      ; T=15    F=**0P0* Rotate Right: m=->{CY,m}
        RR  A                   ; CB 1F      ; T=8     F=**0P0* Rotate Right: m=->{CY,m}
        SLA B                   ; CB 20      ; T=8     F=**0P0* Shift Left Arithmetic: m=m*2
        SLA C                   ; CB 21      ; T=8     F=**0P0* Shift Left Arithmetic: m=m*2
        SLA D                   ; CB 22      ; T=8     F=**0P0* Shift Left Arithmetic: m=m*2
        SLA E                   ; CB 23      ; T=8     F=**0P0* Shift Left Arithmetic: m=m*2
        SLA H                   ; CB 24      ; T=8     F=**0P0* Shift Left Arithmetic: m=m*2
        SLA L                   ; CB 25      ; T=8     F=**0P0* Shift Left Arithmetic: m=m*2
        SLA (HL)                ; CB 26      ; T=15    F=**0P0* Shift Left Arithmetic: m=m*2
        SLA A                   ; CB 27      ; T=8     F=**0P0* Shift Left Arithmetic: m=m*2
        ...
        SRL B                   ; CB 38      ; T=8     F=**0P0* Shift Right Logical: m=->{0,m,CY}
        SRL C                   ; CB 39      ; T=8     F=**0P0* Shift Right Logical: m=->{0,m,CY}
        SRL D                   ; CB 3A      ; T=8     F=**0P0* Shift Right Logical: m=->{0,m,CY}
        SRL E                   ; CB 3B      ; T=8     F=**0P0* Shift Right Logical: m=->{0,m,CY}
        SRL H                   ; CB 3C      ; T=8     F=**0P0* Shift Right Logical: m=->{0,m,CY}
        SRL L                   ; CB 3D      ; T=8     F=**0P0* Shift Right Logical: m=->{0,m,CY}
        SRL (HL)                ; CB 3E      ; T=15    F=**0P0* Shift Right Logical: m=->{0,m,CY}
        SRL A                   ; CB 3F      ; T=8     F=**0P0* Shift Right Logical: m=->{0,m,CY}
        ...
        CALL Z,NN               ; CC XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        CALL NN                 ; CD XX XX   ; T=17    F=------ Unconditional Call: -[SP]=PC,PC=nn
        ADC A,N                 ; CE XX      ; T=7     F=***V0* Add with Carry: A=A+s+CY
        RST 8H                  ; CF         ; T=11    F=------ Restart: (p=0H,8H,10H,...,38H)
        RET NC                  ; D0         ; T=11/5  F=------ Conditional Return: If cc RET
        POP DE                  ; D1         ; T=10    F=------ Pop: register=[SP]+
        JP NC,$+3               ; D2         ; T=10    F=------ Conditional Jump: If cc JP
        OUT (N),A               ; D3 XX      ; T=11    F=------ Output: [port]=r
        CALL NC,NN              ; D4 XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        CALL NC,NN              ; D4 XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        PUSH DE                 ; D5         ; T=11    F=------ Push: -[SP]=register
        SUB N                   ; D6 XX      ; T=7     F=***V1* Subtract: A=A-s
        RST 10H                 ; D7         ; T=11    F=------ Restart: (p=0H,8H,10H,...,38H)
        RET C                   ; D8         ; T=11/5  F=------ Conditional Return: If cc RET
        EXX                     ; D9         ; T=4     F=------ Exchange: qq<->qq' (except AF)
        JP C,$+3                ; DA         ; T=10    F=------ Conditional Jump: If cc JP
        IN A,(N)                ; DB XX      ; T=11    F=------ Input: A=[n]
        CALL C,NN               ; DC XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        ADD IX,BC               ; DD 09      ; T=15    F=--?-0* Add: IX=IX+pp
        ADD IX,DE               ; DD 19      ; T=15    F=--?-0* Add: IX=IX+pp
        LD IX,NN                ; DD 21 XX XX; T=14    F=------ Load: dst=src
        LD (NN),IX              ; DD 22 XX XX; T=20    F=------ Load: dst=src
        INC IX                  ; DD 23      ; T=10    F=------ Increment: xx=xx+1
        ADD IX,IX               ; DD 29      ; T=15    F=--?-0* Add: IX=IX+pp
        LD IX,(NN)              ; DD 2A XX XX; T=20    F=------ Load: dst=src
        DEC IX                  ; DD 2B      ; T=10    F=------ Decrement: xx=xx-1
        INC (IX+N)              ; DD 34 XX   ; T=23    F=***V0- Increment: s=s+1
        DEC (IX+N)              ; DD 35 XX   ; T=23    F=***V1- Decrement: s=s-1
        LD (IX+N),N             ; DD 36 XX XX; T=19    F=------ Load: dst=src
        ADD IX,SP               ; DD 39      ; T=15    F=--?-0* Add: IX=IX+pp
        LD B,(IX+N)             ; DD 46 XX   ; T=19    F=------ Load: dst=src
        LD C,(IX+N)             ; DD 4E XX   ; T=19    F=------ Load: dst=src
        LD D,(IX+N)             ; DD 56 XX   ; T=19    F=------ Load: dst=src
        LD E,(IX+N)             ; DD 5E XX   ; T=19    F=------ Load: dst=src
        LD H,(IX+N)             ; DD 66 XX   ; T=19    F=------ Load: dst=src
        LD L,(IX+N)             ; DD 6E XX   ; T=19    F=------ Load: dst=src
        LD (IX+N),B             ; DD 70 XX   ; T=19    F=------ Load: dst=src
        LD (IX+N),C             ; DD 71 XX   ; T=19    F=------ Load: dst=src
        LD (IX+N),D             ; DD 72 XX   ; T=19    F=------ Load: dst=src
        LD (IX+N),E             ; DD 73 XX   ; T=19    F=------ Load: dst=src
        LD (IX+N),H             ; DD 74 XX   ; T=19    F=------ Load: dst=src
        LD (IX+N),L             ; DD 75 XX   ; T=19    F=------ Load: dst=src
        LD (IX+N),A             ; DD 77 XX   ; T=19    F=------ Load: dst=src
        LD A,(IX+N)             ; DD 7E XX   ; T=19    F=------ Load: dst=src
        ADD A,(IX+N)            ; DD 86 XX   ; T=19    F=***V0* Add: A=A+s
        ADC A,(IX+N)            ; DD 8E XX   ; T=19    F=***V0* Add with Carry: A=A+s+CY
        SUB (IX+N)              ; DD 96 XX   ; T=19    F=***V1* Subtract: A=A-s
        ...
        CP (IX+N)               ; DD BE XX   ; T=19    F=***V1* Compare: A-s
        RLC (IX+N)              ; DD CB XX 06; T=23    F=**0P0* Rotate Left Circular: m=m<-
        RRC (IX+N)              ; DD CB XX 0E; T=23    F=**0P0* Rotate Right Circular: m=->m
        RL (IX+N)               ; DD CB XX 16; T=23    F=**0P0* Rotate Left: m={CY,m}<-
        RR (IX+N)               ; DD CB XX 1E; T=23    F=**0P0* Rotate Right: m=->{CY,m}
        SLA (IX+N)              ; DD CB XX 26; T=23    F=**0P0* Shift Left Arithmetic: m=m*2
        ...
        EX (SP),IX              ; DD E3      ; T=23    F=------ Exchange: [SP]<->register
        PUSH IX                 ; DD E5      ; T=15    F=------ Push: -[SP]=register
        JP (IX)                 ; DD E9      ; T=8     F=------ Unconditional Jump: PC=[register]
        LD SP,IX                ; DD F9      ; T=10    F=------ Load: dst=src
        SBC A,N                 ; DE XX      ; T=7     F=***V1* Subtract with Carry: A=A-s-CY
        RST 18H                 ; DF         ; T=11    F=------ Restart: (p=0H,8H,10H,...,38H)
        RET PO                  ; E0         ; T=11/5  F=------ Conditional Return: If cc RET
        POP HL                  ; E1         ; T=10    F=------ Pop: register=[SP]+
        JP PO,$+3               ; E2         ; T=10    F=------ Conditional Jump: If cc JP
        EX (SP),HL              ; E3         ; T=19    F=------ Exchange: [SP]<->register
        CALL PO,NN              ; E4 XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        PUSH HL                 ; E5         ; T=11    F=------ Push: -[SP]=register
        AND N                   ; E6 XX      ; T=7     F=***P00 Logical AND: A=A&s
        RST 20H                 ; E7         ; T=11    F=------ Restart: (p=0H,8H,10H,...,38H)
        RET PE                  ; E8         ; T=11/5  F=------ Conditional Return: If cc RET
        JP (HL)                 ; E9         ; T=4     F=------ Unconditional Jump: PC=[register]
        JP PE,$+3               ; EA         ; T=10    F=------ Conditional Jump: If cc JP
        EX DE,HL                ; EB         ; T=4     F=------ Exchange: DE<->HL
        CALL PE,NN              ; EC XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        IN B,(C)                ; ED 40      ; T=12    F=***P0- Input: r=[C]
        OUT (C),B               ; ED 41      ; T=12    F=------ Output: [port]=r
        SBC HL,BC               ; ED 42      ; T=15    F=**?V1* Subtract with Carry: HL=HL-ss-CY
        LD (NN),BC              ; ED 43 XX XX; T=20    F=------ Load: dst=src
        NEG                     ; ED 44      ; T=8     F=***V1* Negate: A=-A
        RETN                    ; ED 45      ; T=14    F=------ Return from NMI: PC=[SP]+
        IM 0                    ; ED 46      ; T=8     F=------ Interrupt Mode: (n=0,1,2)
        LD I,A                  ; ED 47      ; T=9     F=------ Load: dst=src
        IN C,(C)                ; ED 48      ; T=12    F=***P0- Input: r=[C]
        OUT (C),C               ; ED 49      ; T=12    F=------ Output: [port]=r
        ADC HL,BC               ; ED 4A      ; T=15    F=**?V0* Add with Carry: HL=HL+ss+CY
        LD BC,(NN)              ; ED 4B XX XX; T=20    F=------ Load: dst=src
        RETI                    ; ED 4D      ; T=14    F=------ Return from Interrupt: PC=[SP]+
        IN D,(C)                ; ED 50      ; T=12    F=***P0- Input: r=[C]
        OUT (C),D               ; ED 51      ; T=12    F=------ Output: [port]=r
        SBC HL,DE               ; ED 52      ; T=15    F=**?V1* Subtract with Carry: HL=HL-ss-CY
        LD (NN),DE              ; ED 53 XX XX; T=20    F=------ Load: dst=src
        IM 1                    ; ED 56      ; T=8     F=------ Interrupt Mode: (n=0,1,2)
        LD A,I                  ; ED 57      ; T=9     F=**0*0- Load: A=i
        IN E,(C)                ; ED 58      ; T=12    F=***P0- Input: r=[C]
        OUT (C),E               ; ED 59      ; T=12    F=------ Output: [port]=r
        ADC HL,DE               ; ED 5A      ; T=15    F=**?V0* Add with Carry: HL=HL+ss+CY
        LD DE,(NN)              ; ED 5B XX XX; T=20    F=------ Load: dst=src
        IM 2                    ; ED 5E      ; T=8     F=------ Interrupt Mode: (n=0,1,2)
        IN H,(C)                ; ED 60      ; T=12    F=***P0- Input: r=[C]
        OUT (C),H               ; ED 61      ; T=12    F=------ Output: [port]=r
        SBC HL,HL               ; ED 62      ; T=15    F=**?V1* Subtract with Carry: HL=HL-ss-CY
        RRD                     ; ED 67      ; T=18    F=**0P0- Rotate Right 4 bits: {A,[HL]}=->{A,[HL]}
        IN L,(C)                ; ED 68      ; T=12    F=***P0- Input: r=[C]
        OUT (C),L               ; ED 69      ; T=12    F=------ Output: [port]=r
        ADC HL,HL               ; ED 6A      ; T=15    F=**?V0* Add with Carry: HL=HL+ss+CY
        RLD                     ; ED 6F      ; T=18    F=**0P0- Rotate Left 4 bits: {A,[HL]}={A,[HL]}<-
        SBC HL,SP               ; ED 72      ; T=15    F=**?V1* Subtract with Carry: HL=HL-ss-CY
        LD (NN),SP              ; ED 73 XX XX; T=20    F=------ Load: dst=src
        IN A,(C)                ; ED 78      ; T=12    F=***P0- Input: r=[C]
        OUT (C),A               ; ED 79      ; T=12    F=------ Output: [port]=r
        ADC HL,SP               ; ED 7A      ; T=15    F=**?V0* Add with Carry: HL=HL+ss+CY
        LD SP,(NN)              ; ED 7B XX XX; T=20    F=------ Load: dst=src
        ...
        RET P                   ; F0         ; T=11/5  F=------ Conditional Return: If cc RET
        POP AF                  ; F1         ; T=10    F=------ Pop: register=[SP]+
        JP P,$+3                ; F2         ; T=10    F=------ Conditional Jump: If cc JP
        DI                      ; F3         ; T=4     F=------ Disable Interrupts
        CALL P,NN               ; F4 XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        ...
        RET M                   ; F8         ; T=11/5  F=------ Conditional Return: If cc RET
        LD SP,HL                ; F9         ; T=6     F=------ Load: dst=src
        JP M,$+3                ; FA         ; T=10    F=------ Conditional Jump: If cc JP
        EI                      ; FB         ; T=4     F=------ Enable Interrupts
        CALL M,NN               ; FC XX XX   ; T=17/10 F=------ Conditional Call: If cc CALL
        ADD IY,BC               ; FD 09      ; T=15    F=--?-0* Add: IY=IY+rr
        ADD IY,DE               ; FD 19      ; T=15    F=--?-0* Add: IY=IY+rr
        LD IY,NN                ; FD 21 XX XX; T=14    F=------ Load: dst=src
        LD (NN),IY              ; FD 22 XX XX; T=20    F=------ Load: dst=src
        INC IY                  ; FD 23      ; T=10    F=------ Increment: xx=xx+1
        ADD IY,IY               ; FD 29      ; T=15    F=--?-0* Add: IY=IY+rr
        LD IY,(NN)              ; FD 2A XX XX; T=20    F=------ Load: dst=src
        DEC IY                  ; FD 2B      ; T=10    F=------ Decrement: xx=xx-1
        INC (IY+N)              ; FD 34 XX   ; T=23    F=***V0- Increment: s=s+1
        DEC (IY+N)              ; FD 35 XX   ; T=23    F=***V1- Decrement: s=s-1
        LD (IY+N),N             ; FD 36 XX XX; T=19    F=------ Load: dst=src
        ADD IY,SP               ; FD 39      ; T=15    F=--?-0* Add: IY=IY+rr
        LD B,(IY+N)             ; FD 46 XX   ; T=19    F=------ Load: dst=src
        LD C,(IY+N)             ; FD 4E XX   ; T=19    F=------ Load: dst=src
        LD D,(IY+N)             ; FD 56 XX   ; T=19    F=------ Load: dst=src
        LD E,(IY+N)             ; FD 5E XX   ; T=19    F=------ Load: dst=src
        LD H,(IY+N)             ; FD 66 XX   ; T=19    F=------ Load: dst=src
        LD L,(IY+N)             ; FD 6E XX   ; T=19    F=------ Load: dst=src
        LD (IY+N),B             ; FD 70 XX   ; T=19    F=------ Load: dst=src
        LD (IY+N),C             ; FD 71 XX   ; T=19    F=------ Load: dst=src
        LD (IY+N),D             ; FD 72 XX   ; T=19    F=------ Load: dst=src
        LD (IY+N),E             ; FD 73 XX   ; T=19    F=------ Load: dst=src
        LD (IY+N),H             ; FD 74 XX   ; T=19    F=------ Load: dst=src
        LD (IY+N),L             ; FD 75 XX   ; T=19    F=------ Load: dst=src
        LD (IY+N),A             ; FD 77 XX   ; T=19    F=------ Load: dst=src
        LD A,(IY+N)             ; FD 7E XX   ; T=19    F=------ Load: dst=src
        ADD A,(IY+N)            ; FD 86 XX   ; T=19    F=***V0* Add: A=A+s
        ADC A,(IY+N)            ; FD 8E XX   ; T=19    F=***V0* Add with Carry: A=A+s+CY
        SUB (IY+N)              ; FD 96 XX   ; T=19    F=***V1* Subtract: A=A-s
        ...
        CP (IY+N)               ; FD BE XX   ; T=19    F=***V1* Compare: A-s
        RLC (IY+N)              ; FD CB XX 06; T=23    F=**0P0* Rotate Left Circular: m=m<-
        RRC (IY+N)              ; FD CB XX 0E; T=23    F=**0P0* Rotate Right Circular: m=->m
        RL (IY+N)               ; FD CB XX 16; T=23    F=**0P0* Rotate Left: m={CY,m}<-
        RR (IY+N)               ; FD CB XX 1E; T=23    F=**0P0* Rotate Right: m=->{CY,m}
        SLA (IY+N)              ; FD CB XX 26; T=23    F=**0P0* Shift Left Arithmetic: m=m*2
        ...
        EX (SP),IY              ; FD E3      ; T=23    F=------ Exchange: [SP]<->register
        PUSH IY                 ; FD E5      ; T=15    F=------ Push: -[SP]=register
        JP (IY)                 ; FD E9      ; T=8     F=------ Unconditional Jump: PC=[register]
        LD SP,IY                ; FD F9      ; T=10    F=------ Load: dst=src
        CP N                    ; FE XX      ; T=7     F=***V1* Compare: A-s
